...
class SearchResultCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        self.scoreLabel.frame = CGRect(x: 20, y: 0, width: 70, height: 30)
    }
    
    
    func createGraph() {
        self.graphView = GaugeView(frame: CGRect(x:self.contentView.frame.width/1.8, y:self.contentView.frame.height * 1.5, width: 200, height: 200))
